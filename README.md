...
**🔍 AttriSense HR Dashboard**  
An enterprise-grade AI-powered people analytics dashboard built with **Streamlit** and **Python**, designed to predict employee attrition, visualize key insights, and improve workforce decisions.

🧠 Key Features:
- CSV upload and dynamic data population
- Real-time interactive insights and alerts
- Clickable charts (bar, pie, heatmap) with drill-downs
- Sidebar navigation styled like a modern HR SaaS platform
...
- 🌐 [LinkedIn](https://linkedin.com/in/shinora-khan)  
- 📧 shinora.khan@email.ucr.edu

---

🔍 *Open to opportunities in HR analytics, employer branding, people operations, and marketing strategy.*
